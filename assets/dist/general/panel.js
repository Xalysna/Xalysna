...
const navigationButtons = [
  { label: 'Inicio', link: `${baseUrl}public/index.html`, image: `${baseUrl}assets/img/nav/inicio.svg` },
  { 
    label: 'Blog',
    link: `${baseUrl}public/content/blog/xalysna-blog/xalysna-blog-files/index.html`,
    image: `${baseUrl}assets/img/nav/blog.svg`,
  },
  { label: 'Utilidades', link: `${baseUrl}public/construction.html`, image: `${baseUrl}assets/img/nav/tool.svg` },
  { label: 'Xalysna Token', link: `${baseUrl}public/construction.html`, image: `${baseUrl}assets/img/nav/token.svg` },
];
